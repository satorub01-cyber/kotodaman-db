document.addEventListener('DOMContentLoaded', function () {
    ...
    function getAutoInputData() {
        ...
        return {
            character_name: getValue('auto_input_character_name'),
            texts: {
                auto_input_waza_name: getValue('auto_input_waza_name'),
                auto_input_waza: getValue('auto_input_waza'),
                auto_input_sugowaza_name: getValue('auto_input_sugowaza_name'),
                auto_input_sugowaza: getValue('auto_input_sugowaza'),
                auto_input_sugowaza_condition: getValue('auto_input_sugowaza_condition'),
                auto_input_trait1: getValue('auto_input_trait1'),
                auto_input_trait2: getValue('auto_input_trait2'),
                auto_input_blessing: getValue('auto_input_blessing'),
                // 0〜4凸の入力値を配列化して取得
                auto_input_kotowaza: [0, 1, 2, 3, 4].map(i => ({
                    condition: getValue(`auto_input_kotowaza_cond_${i}`),
                    effect: getValue(`auto_input_kotowaza_effect_${i}`)
                }))
            }
        };
    }

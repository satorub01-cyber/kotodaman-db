document.addEventListener('DOMContentLoaded', function() {
    ...
    function getAutoInputData() {
        return {
            ...
            texts: {
                auto_input_waza_name: document.getElementById('auto_input_waza_name')?.value || '',
                auto_input_waza: document.getElementById('auto_input_waza')?.value || '',
                auto_input_sugowaza_name: document.getElementById('auto_input_sugowaza_name')?.value || '',
